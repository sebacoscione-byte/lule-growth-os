...
// drawtext no hace word-wrap solo -- el texto de una tarjeta se corta contra los bordes del video
// (720px de ancho, formato vertical) si no se corta a mano, por palabra entera, nunca a mitad de una
// palabra.
