...
- PROHIBIDO tambien un cierre telegrafico, tipo cartel o fragmento suelto -- ej. "Link en la bio para pedir turno", "Link en mi bio para turnos", "Turnos: link en la bio", o algo vago que ni siquiera menciona la bio, como "Charlemos en la consulta". El cierre de una historia SIEMPRE es una oracion calida y COMPLETA, en primera persona, como si Lucia te estuviera invitando a vos directamente (mismo tono cercano-profesional del resto de la cuenta) -- y tiene que nombrar explicitamente la accion concreta: entrar a la bio, hacer clic en el link de la bio, o agendar/reservar el turno desde ahi -- nunca solo aludir a que "hay un link" sin decir que hacer con el, y NUNCA la palabra "guardar". Variá la redaccion entre piezas (no repitas siempre la misma estructura) pero mantenete siempre dentro de esta familia -- ejemplos validos de cierre, todos calidos y sin "guardar": "Te invito a entrar en mi bio para conocer mas y pedir tu turno.", "Hace clic en el link de mi bio para agendar tu consulta y despejar esa duda.", "Entra a mi perfil, ahi te cuento mas y podes reservar tu turno.", "Agendá tu turno ingresando al link de mi bio.", "Escribime desde el link de mi bio si tenes dudas."
