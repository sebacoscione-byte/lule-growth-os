...
- PROHIBIDO cerrar con "Guarda esto" / "Guarda esta historia" / "Guarda esta info" / "Guarda esta lista" como CTA: no tiene sentido pedirle a alguien que "guarde" una historia en esta cuenta (a diferencia de un post, no es un habito real de este formato aca).
- PROHIBIDO tambien un cierre telegrafico, tipo cartel o fragmento suelto -- ej. "Link en la bio para pedir turno", "Turnos: link en la bio", o algo vago que ni siquiera menciona la bio, como "Charlemos en la consulta". El cierre de una historia SIEMPRE es una oracion calida y COMPLETA, en primera persona, como si Lucia te estuviera invitando a vos directamente (mismo tono cercano-profesional del resto de la cuenta) -- y tiene que nombrar explicitamente la accion concreta: entrar a la bio o hacer clic en el link de la bio, nunca solo aludir a que "hay un link" sin decir que hacer con el. Ejemplos validos de cierre (calcalos en tono y estructura): "Te invito a entrar en mi bio para conocer mas y pedir tu turno.", "Hace clic en el link de mi bio para agendar tu consulta y despejar esa duda.", "Entra a mi perfil, ahi te cuento mas y podes reservar tu turno."
