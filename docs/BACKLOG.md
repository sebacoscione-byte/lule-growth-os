...
## [RESUELTO] ✅ Cartilla completa del Hospital Británico (2026-09-01)
...
- La landing principal y las de CABA/Lanús muestran la cartilla completa. Sólo dentro del bloque de
  coberturas se usan **Hospital Británico** y **Swiss Medical**; las sedes físicas mantienen sus
  nombres completos en el resto de la experiencia.
- Se verificó el bloque en formato celular y la cartilla extensa se mantiene legible.
- No se modificaron lógica médica, webhooks, cron jobs, autenticación ni RLS.
...
- Organización verificada y prueba real única con calidad `low` aprobada: OpenAI respondió 200 y
  devolvió una imagen PNG válida de 832x1040. El motor quedó habilitado de punta a punta.
