# EN CURSO (2026-08-23) — señales de indexación en Google Search Console
...
- [ ] Ejecutar lint, Jest, build y E2E público; validar preview y producción.
- [ ] Publicar y mergear el PR con CI limpio.
