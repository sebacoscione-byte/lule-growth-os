...
insert into templates (name, category, body_text, variables) values
  ...
  ('seguimiento_post_consulta', 'utility', 'Hola {{1}}, te escribimos sobre tu atención con la Dra. Lucía Chahin para saber cómo seguís después de tu consulta. Si tenés dudas sobre las indicaciones que te dieron, consultá directamente con la institución donde te atendiste.', '["nombre"]'),
  ('invitacion_protocolo', 'utility', 'Hola {{1}}, en el marco de tu atención con la Dra. Lucía Chahin, tu perfil médico podría ser compatible con el protocolo de investigación {{2}}. Es voluntario y requiere tu consentimiento explícito antes de avanzar. Respondé este mensaje si querés que te contactemos con más información.', '["nombre", "protocolo"]'),
