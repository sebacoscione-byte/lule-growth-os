...
- 2026-08-26: Hospital Británico Central y Lanús comparten el único WhatsApp institucional
  guardado en `app_config.locations`. La herencia se limita al WhatsApp: dirección, horario,
  teléfono e instrucciones continúan resolviéndose de forma independiente para cada sede. La
  pantalla Configuración identifica el campo y el resumen como compartidos entre Central y Lanús.
